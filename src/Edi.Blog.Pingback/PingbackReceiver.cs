...
namespace Edi.Blog.Pingback
{
    public class PingbackReceiver : IPingbackReceiver
    {
        ...
        public async Task<PingbackServiceResponse> ValidatePingRequest(HttpContext context)
        {
            try
            {
                HttpContext = context;
                ...
                {
                    return PingbackServiceResponse.TerminatedMethodNotFound;
                }
                ...
                if (list == null)
                {
                    ...
                    return PingbackServiceResponse.TerminatedUrlNotFound;
                }
                ...
                return PingbackServiceResponse.ValidPingRequest;
            }
            catch (Exception e)
            {
